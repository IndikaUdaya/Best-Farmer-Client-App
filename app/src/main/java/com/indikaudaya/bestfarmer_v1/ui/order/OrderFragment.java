package com.indikaudaya.bestfarmer_v1.ui.order;
...
public class OrderFragment extends Fragment {
    ...
    private void loadOrderProduct() {
        ...
        Call<List<ProductDTO>> products = apiService.getProductOrderItems(sellerId);
    ...
    private void initListedRecycler(ArrayList<OrderModel> models) {
        RecyclerView recyclerView = root.findViewById(R.id.ListedRecycleView);
        OrderAdapter listed = new OrderAdapter(getContext(), models);
